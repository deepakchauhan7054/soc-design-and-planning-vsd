...
This document provides results, execution summaries, and root-cause analysis for Gate-Level Simulations (GLS) executed on the Caravel Management SoC using the SkyWater 130nm (`sky130_fd_sc_hd`) standard cell library.

---

## 1. Standalone Test Summary Table

| Test Suite | RTL Status (Week-3) | GLS Status (Week-5) | Remarks |
| :--- | :---: | :---: | :--- |
