...
- Execution logs
- Stage-wise screenshots
- Synthesis report
- Floorplan evidence
- Placement evidence
- CTS evidence
- Routing evidence
- Fill insertion evidence
- Final GDS evidence
- Timing reports
- Debugging notes
...
- Wrapper dependencies are identified
- ORFS environment is configured
- RTL sources are correctly organized
- 100 MHz clock constraint is applied
- RTL-to-GDS flow completes successfully
- Final filled database is generated
- Final netlist is generated
- GDSII is generated
- Timing reports are collected
